...
/*
 * The documents failure state. A fetch that errors has to say so and offer a way
 * back — leaving a skeleton up forever reads as "still loading" and gives the
 * customer nothing to act on (Design.md).
 */
  ...
  return (
    ...
    >
      ...
      <p className="max-w-[22.5rem] text-body text-gray-500">
        Something went wrong fetching your documents. Please try again.
      </p>
      <button
        type="button"
        onClick={onRetry}
