...
/*
 * The visual half of `usePullToRefresh` for the portal shell — a disc that
 * slides down from behind the top bar as the customer pulls, then spins while
 * the screen's queries refetch.
 *
 ...
 * fixed` slide-overs the pages inside render, which is the same trap the shell's
 * fade-in animation already avoids.
 *
 * The admin shell has its own copy — areas never import from each other.
 */
