        ...
        <div className="mx-auto flex w-full max-w-[1200px] flex-col gap-6 lg:gap-8">
          ...
          <div className="flex w-full flex-col gap-3">
            <div className="flex w-full flex-col gap-3 lg:flex-row lg:items-center lg:justify-between">
                ...
                {STATUS_TABS.map((tab) => {
                  ...
                  return (
                    <button
                      ...
                      className={`whitespace-nowrap rounded-[8px] px-3.5 py-2 text-[13px] font-semibold transition-colors ${
                        active
              ...
              <label className="relative flex w-full items-center lg:w-[280px]">
