      ...
      <div ref={containerRef} className="relative w-full">
        ...
        {open ? (
          <ul
            ...
            role="listbox"
            aria-labelledby={labelId}
            className="absolute left-0 top-full z-30 mt-2 max-h-[17.5rem] w-full overflow-y-auto rounded-card border border-gray-200 bg-white p-1.5 shadow-lg-elevation"
          >
            {options.map((option) => {
