 ...
 *
 * One component, two presentations, as the task asks: a bottom sheet that rises
 * from the bottom edge on mobile, and a centered modal from `md` up. Both are
 * the same element — mobile pins it to the bottom with only its top corners
 * rounded, and `md` releases it to the centre of the viewport — so the form
 * inside is written once.
 *
